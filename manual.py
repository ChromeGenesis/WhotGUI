...
when someone asks for a card (plays 'whot' with number 20)
the opponent must deliver that card or go to mart else it'll be considered an invalid
move
...
Powerup Usage
=============
* when one Player plays the card 'whot' (having the number 20) , 
...
Shortcuts
=========
the "Return" (Enter) key can be used to go to mart (for
a human player)
"""
