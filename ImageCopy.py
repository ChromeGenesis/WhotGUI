...
class images:
    def __init__(self):
        ...
        self._misc_whot2 = tk.PhotoImage(file=".//DIY//Misc//Misc_whot3.png")
        self._misc_whot3 = tk.PhotoImage(file=".//DIY//Misc//Misc_whot4.png")
        self._misc_whot4 = tk.PhotoImage(file=".//DIY//Misc//Misc_whot5.png")
        self._misc_whot5 = tk.PhotoImage(file=".//DIY//Misc//Misc_whot6.png")
        self._misc_whot6 = tk.PhotoImage(file=".//DIY//Misc//Misc_whot7.png")
        self._misc_whot7 = tk.PhotoImage(file=".//DIY//Misc//Misc_whot8.png")
        self._misc_whot8 = tk.PhotoImage(file=".//DIY//Misc//Misc_whot9.png")
        self._misc_whot9 = tk.PhotoImage(file=".//DIY//Misc//Misc_whot10.png")
        self._misc_whot10 = tk.PhotoImage(file=".//DIY//Misc//Misc_whot11.png")
        self._misc_whot11 = tk.PhotoImage(file=".//DIY//Misc//Misc_whot12.png")
