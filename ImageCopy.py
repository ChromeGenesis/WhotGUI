...
class images:
    def __init__(self):
        ...
        self._square15 = tk.PhotoImage(file=".//DIY//Square/Square_15.png")
        ...
        self._cross17 = tk.PhotoImage(file=".//DIY//Cross/Cross_17.png")
        ...
        self._whot1 = tk.PhotoImage(file=".//DIY//Whot//whot1_20.png")
        self._whot2 = tk.PhotoImage(file=".//DIY//Whot//whot2_20.png")
        self._whot3 = tk.PhotoImage(file=".//DIY//Whot//whot3_20.png")
        self._whot4 = tk.PhotoImage(file=".//DIY//Whot//whot4_20.png")

        circle=[(self._circle2, ('circle',2)), (self._circle4, ('circle',4)), (self._circle7, ('circle',7)),
                  (self._circle3, ('circle',3)), (self._circle13, ('circle',13)), (self._circle12, ('circle',12)),
                  (self._circle11, ('circle',11)), (self._circle14, ('circle',14)), (self._circle1, ('circle',1)),
                  (self._circle10, ('circle',10)), (self._circle3, ('circle',3))]

        triangle=[(self._triangle4, ('triangle',4)), (self._triangle1, ('triangle',1)), (self._triangle3, ('triangle',3)),
          (self._triangle13, ('triangle',13)), (self._triangle10, ('triangle',10)), (self._triangle14, ('triangle',14)),
          (self._triangle8, ('triangle',8)), (self._triangle7, ('triangle',7)), (self._triangle11, ('triangle',11))]

        square=[(self._square14, ('square',14)), (self._square7, ('square',7)), (self._square2, ('square',2)), (self._square1, ('square',1)),
        (self._square11, ('square',11)), (self._square15, ('square',15)), (self._square10, ('square',10)), (self._square13, ('square',13))]

        cross=[(self._cross11, ('cross',11)), (self._cross14, ('cross',14)), (self._cross3, ('cross',3)), (self._cross2, ('cross',2)),
       (self._cross5, ('cross',5)), (self._cross10, ('cross',10)), (self._cross17, ('cross',17)),
       (self._cross1, ('cross',1))]

        star=[(self._star4, ('star',4)), (self._star8, ('star',8)), (self._star2, ('star',2)), (self._star5, ('star',5)),
      (self._star3, ('star',3)), (self._star1, ('star',1))]
